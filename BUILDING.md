...
These libraries are usually not installed by default on any Mac OS X system and
partially on most Linux systems. For information on how to get and install the
required libraries, see 'Installing Required Libraries' below.
...
*Note: On Mac OS X, All dynamically loaded libraries and all their dependencies
are automatically repackaged into the application bundle to make it fully
self-contained.*
