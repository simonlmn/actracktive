...
#ifndef EQUALIZEHISTOGRAM_H_
#define EQUALIZEHISTOGRAM_H_

#include "actracktive/processing/nodes/sources/filter/ImageFilter.h"

class EqualizeHistogram: public ImageFilter
{
public:
	static const Node::Type& TYPE();
	const Node::Type& getType() const;

	EqualizeHistogram(const std::string& id, const std::string& name = "Equalize Histogram");
